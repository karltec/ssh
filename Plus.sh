...
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%40s%s%-12s\n' "BEM VINDO A KARL TEC NET" ; tput sgr0
echo -e "\033[1;31m════════════════════════════════════════════════════\033[0m"
echo ""
...
echo ""
echo -e "\033[1;31m≠×≠×≠×≠×≠×≠×≠×≠×[\033[1;33m • \033[1;32mKARL TEC \033[1;33m •\033[1;31m ]≠×≠×≠×≠×≠×≠×≠×≠×\033[0m"
echo ""
...
wget https://raw.githubusercontent.com/karltec/ssh/master/Install/list?token=ANNJ2UHU5NMHG2FSHUXSDYS7AE5XO > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/karltec/ssh/master/Install/versao?token=ANNJ2UAEINZBPZSFF24OPDK7AE52Y > /dev/null 2>&1
clear
echo ""
cd $HOME
